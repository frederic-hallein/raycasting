...
Step 4: By running the `make all` command, it creates a `main` executable file in the same directory.  \
Step 5: Run the executable using the following command: `./main`. 
